...
> It should be noted that all fields are optional by default in the latest protocol buffer schema version, which could be an advantage feature-wise at the cost of a slight performance disadvantage.
